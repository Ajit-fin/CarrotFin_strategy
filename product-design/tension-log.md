...
**Why unresolved:** Trust is progressive (see [behavioral-framework.md](file:///Users/kshekhaw/Documents/CarrotFin_strategy/product-design/behavioral-framework.md) Part 6: Trust Architecture), but we don't know the trust ramp. How many value-delivering interactions does a user need before they'll share their income? Their bank statement? Their debts? The entire UX architecture depends on this ramp speed, and we have zero data.
